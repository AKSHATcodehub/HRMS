...
export const REQUESTED_ASSETS_HEADING = [
    ...
    { heading: 'Requested At', key: 'Requested_At', type: 'text'},
...
export const REQUESTED_ASSETS_TABLE_DATA = [
    { s_no:1 , Status:'None', Request_Reason:'none',Priority:'Low',Requested_At:'Admin',Assets_Category:'Desktop',Allocation_type:'Permanent',Company:'HP'}
]